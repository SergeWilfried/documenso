---
title: 'Deploying Notario with Vercel, Supabase and Resend'
description: This is the first part of the new Building Notario series, where I describe the challenges and design choices that we make while building the world’s most open signing platform.
...
In this article, we'll walk you through how to deploy and self-host Notario using Vercel, Supabase, and Resend.
...
If you don't know what [Notario](https://documenso.com/) is, it's an open-source alternative to DocuSign, with the mission to create an open signing infrastructure while embracing openness, cooperation, and transparency.
...
## Step-by-Step guide to deploying Notario with Vercel, Supabase, and Resend

To deploy Notario, we'll take the following steps:

1. Fork the Notario repository
...
### Step 1: Fork the Notario repository

Start by creating a fork of Notario on GitHub. You can do this by visiting the [Notario repository](https://github.com/documenso/documenso) and clicking on the 'Fork' button. (Also, star the repo!)

![Notario](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wkcujctpf86p56bju3mq.png)

Choose your GitHub profile as the owner and click on 'Create fork' to create a fork of the repo.

![Fork the Notario repository on GitHub](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xf49r2byu9nnd1465niy.png)
...
So, you've just cloned Notario, installed dependencies on your local machine, and set your database using Supabase. Now, SMTP is missing. Emails won't go out! Let's fix it with Resend.
...
On your Vercel dashboard, create a new project using the forked project from your GitHub repositories. Select the project among the options and click '**Import**' to start running Notario.
...
![Deploying Notario](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/secg29j9j40o4u2oa8o8.png)

Congratulations! 🎉 You've successfully deployed Notario using Vercel, Supabase, and Resend. You're now ready to create and sign your own documents with your self-hosted Notario!
...
Over to you! How was the tutorial? If you enjoyed it, [please do share](https://twitter.com/documenso/status/1700141802693480482)! And if you have any questions or comments, please reach out to me on [Twitter / X](https://twitter.com/EphraimDuncan_) (DM open) or [Discord](#).
