---
title: Preview the next Notario
description: We're redesigning Notario by making it more elegant and appropriately playful. Here's a sneak peek.
...
Since we launched [Notario 0.9 on Product Hunt](https://producthunt.com/products/documenso#documenso) last May, the team's been hard at work behind the scenes to ramp up development and design to deliver an excellent next version.

Last week, Lucas shared the reasoning how [why we're doing a rewrite](https://documenso.com/blog/why-were-doing-a-rewrite).

Today, I'm pleased to share with you a preview of the next Notario.

## Preview the next Notario
...
Make sure to [star the GitHub repository](https://documen.so/github), [follow us on X](http://documen.so/twitter) and [join the Discord server](#) to keep up to date with all things Notario.
