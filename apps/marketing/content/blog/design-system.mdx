...
> TLDR; Our design system is OSS under MIT at [design.tampon.xyz](https://design.tampon.xyz)

Today, we are open sourcing our design system, lovingly crafted by [Thilo](https://twitter.com/thilokonzok). The system is public on Figma and will be available at [design.tampon.xyz](https://design.tampon.xyz) from here on out.
