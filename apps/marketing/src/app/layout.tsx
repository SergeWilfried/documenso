...
export function generateMetadata() {
  return {
    ...
    authors: { name: 'Studio Bangré, Inc.' },
    robots: 'index, follow',
    metadataBase: new URL(NEXT_PUBLIC_MARKETING_URL() ?? 'http://localhost:3000'),
    openGraph: {
      title: 'MonTampon - The DocuSign Alternative',
      description:
        'Join Tampon, and get a 10x better signing experience. Pricing starts at $30/mo. forever! Sign in now and enjoy a faster, smarter, and more beautiful document signing process. Integrates with your favorite tools, customizable, and expandable. Support our mission and become a part of our open-source community.',
      type: 'website',
