      ...
      <div className="relative">
            ...
            >
              ...
              >
                <img
                  ...
                  alt="Tampon - The open source DocuSign alternative | Product Hunt"
        ...
        >
          <Widget className="mt-12">
            <strong>Tampon Supporter Pledge</strong>
            ...
            <p className="w-full max-w-[70ch]">
              Through our platform, called Tampon, we strive to earn your trust by allowing
            ...
            <p className="w-full max-w-[70ch]">
              At Tampon, we envision a web-enabled future for business and contracts, and we are
            ...
            <p className="w-full max-w-[70ch]">
              ...
              signal your support of Tampon's mission{' '}
            ...
            <div>
              ...
              <p className="mt-1">Co-Founders, Tampon</p>
            </div>
          </Widget>
        </motion.div>
      </div>
