...
import {
  TAddTemplatePlaceholderRecipientsFormSchema,
  ZAddTemplatePlaceholderRecipientsFormSchema,
} from './types';
...
export type AddTemplatePlaceholderRecipientsFormProps = {
  ...
  onSubmit: (_data: TAddTemplatePlaceholderRecipientsFormSchema) => void;
};
...
export const AddTemplatePlaceholderRecipientsFormPartial = ({
  ...
  } = useForm<TAddTemplatePlaceholderRecipientsFormSchema>({
    resolver: zodResolver(ZAddTemplatePlaceholderRecipientsFormSchema),
    defaultValues: {
      signers:
        recipients.length > 0
  ...
  const onAddPlaceholderRecipient = () => {
    ...
    appendSigner({
      ...
      email: `johndoe${placeholderRecipientCount}@progiciel.co`,
    });
  };
